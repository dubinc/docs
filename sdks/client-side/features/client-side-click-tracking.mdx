...
- You're using [Dub Partners](/partners/quickstart) with [dual-sided incentives](/partners/dual-sided-incentives) and want to display a banner that says: _"John referred you to Acme and gave you 25% off"_
...
- The specific query parameter + you specified in [Step 3](#install-the-dub-client-side-sdk)
...
1. The click tracked correctly in the [**Events**](https://app.dub.co/events) tab of your Dub workspace.
...
- Dynamic user-generated content/webpages – examples:
  - Dub's public analytics dashboards (e.g. d.to/stats/try)
  - Cal.com's booking pages (e.g. cal.com/peer)
  - Product Hunt's launch pages (e.g. producthunt.com/posts/dub)
...
## Bonus: Fetching partner and discount data

If you're using [Dub Partners](/partners/quickstart) with [dual-sided incentives](/partners/dual-sided-incentives), the script will automatically fetch the partner and discount data for you when someone lands on your site via a valid referral link.
