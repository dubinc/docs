...
<Accordion title="Deep links not opening your app">

Make sure you've [allowlisted your short link domain](#allowlist-your-deep-link-domain-in-your-app) in your app's configuration. This is required for both iOS and Android to recognize and handle links from your domain.

</Accordion>

<Accordion title="App not detected even though it's installed">

This is typically caused by iOS or Android caching the deep link configuration. Try uninstalling and reinstalling your app to clear the cache. This forces the operating system to re-fetch the `apple-app-site-association` or `assetlinks.json` files.

</Accordion>

<Accordion title="Deep links work sometimes but not always">
