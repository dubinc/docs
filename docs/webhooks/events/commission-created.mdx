...
Event triggered when a [commission is created](/docs/api-reference/commissions/list) for a partner. Clawbacks also trigger this event with a negative amount.
