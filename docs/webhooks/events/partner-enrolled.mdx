...
Occurs whenever a [partner is enrolled](/docs/api-reference/partners/create) in your program (either their application was approved, they accepted your invite, or via the API).
