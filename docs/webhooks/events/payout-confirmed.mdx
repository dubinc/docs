...
Event triggered when a [payout](/docs/api-reference/payouts/list) is confirmed and ready for [external processing](/docs/partners/external-payouts). Only sent for programs using external or hybrid payout modes.
