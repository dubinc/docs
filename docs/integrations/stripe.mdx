...
- [Option 4: Using Stripe Coupons and Promotion Codes](#option-4-using-stripe-discounts-and-promotion-codes)
...
### Option 4: Using Stripe Coupons and Promotion Codes

If you're using [Stripe Coupons and Promotion Codes](https://docs.stripe.com/billing/subscriptions/coupons), you can start tracking sale conversions simply by [installing the Stripe integration](#installing-the-dub-stripe-integration) in your Dub workspace.

Then, [follow these steps](/help/article/dual-sided-incentives#option-2-using-stripe-promo-codes-no-code-required) to generate discount codes for your partners on Dub, and you are all set!
...
<Note>
  While Stripe promo-code-based discounts is much easier to set up (no code
  required), you sacrifice attribution accuracy since you won't have any
...
2. Matches it against any [product-specific reward modifiers](/help/article/sale-rewards#product-spotlight) configured for the partner's group.
