...
For more advanced features like [custom link previews](https://dub.co/help/article/custom-link-previews), [conversion tracking](/conversions/quickstart), and more, see the full list of properties [here](/api-reference/endpoint/create-a-new-link).
...
Check out the [full API reference for the link creation endpoint](/api-reference/endpoint/create-a-new-link).
