...
Before you begin, make sure to add a [deep link domain](/concepts/links/deep-links/quickstart#step-1%3A-configure-your-deep-link-domains-on-dub) in your Dub workspace. This replaces Firebase's `*.page.link` domain with your own branded deep link domain.
...
<Step title="2. Update AndroidManifest.xml">
...
<Step title="3. Implement Deep Link Handling">
