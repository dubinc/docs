...
When your app isn't installed, the user will be redirected to the App Store or Google Play Store if you've enabled [device targeting](https://dub.co/help/article/device-targeting) for the deep links.

After they install and open your app, you'll need to use [deferred deep linking](/concepts/links/deep-links/deferred-deep-linking) to retrieve the original destination URL.
