...
Most of the OAuth client libraries will handle the following steps for you:

- Redirecting users to the OAuth provider's authorization page
- Handling the callback from the OAuth provider
