...
To configure webhooks for your Dub workspace, you'll need to follow these steps:
...
Due to the high volume nature of these events, they are scoped to a specific link. This means that you need to specify the link when creating a webhook – though you can select multiple links if you'd like.
