...
1. Go through the [program onboarding flow](https://app.dub.co/programs) to create your program.
...
5. Set up a [whitelabeled referral dashboard](/partners/white-labeled-referral-dashboard) that lives directly inside your app so your users can automatically enroll in your partner program without leaving your app.
