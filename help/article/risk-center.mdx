...
If the partner is legitamate and has multiple accounts, it's receommended they [merge their accounts](/help/article/merging-partner-accounts#merging-your-partner-accounts) to prevent any future issues. If the accounts are not merged, this can be a sign of self-referral, which is when a partner refers themselves to earn commissions or rewards. 
