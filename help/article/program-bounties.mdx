...
| Eligibility            | [Partner group](/help/article/partner-groups) and [parnter tag](/help/article/partner-tags) eligibility. The same bounty can be applied to multiple partner [groups](/help/article/partner-groups), [tags](/help/article/partner-tags) – or all partners in your program. |
...
<Frame>
  <img
    src="/images/dub-partners/bounty-duration.png"
    alt="Bounty duration"
  />
</Frame>
...
<Frame>
  <img
    src="/images/dub-partners/bounty-enddate.png"
    alt="Bounty end date"
  />
</Frame>
