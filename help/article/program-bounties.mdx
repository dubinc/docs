...
- [Social metrics bounties](#social-metrics)
...
<Frame>
  <img
    src="/images/dub-partners/bounty-performance.png"
...
| Start date (optional)  | Bounty start date. Partners will receive an email notification on this date about the bounty. If one is not selected, the bounty will start on the creation date. [Learn more](/help/article/program-bounties#bounty-start-date)                                          |
| End date (optional)    | Bounty end date. If set, bounty will "expire" after the end date and will no longer be eligible for commission. [Learn more](/help/article/program-bounties#bounty-end-date)                                                                                              |
| Criteria               | The success criteria are based on: total leads, total conversions, total revenue, or total commissions. [Learn more](/help/article/program-bounties#performance-logic).                                                                                                   |
| Reward                 | The reward amount the partner will receive upon completing the bounty.                                                                                                                                                                                                    |
| Eligibility            | [Partner group](/help/article/partner-groups) and [partner tag](/help/article/partner-tags) eligibility. The same bounty can be applied to multiple partner [groups](/help/article/partner-groups), [tags](/help/article/partner-tags) – or all partners in your program. |
...
<Frame>
  <img
    src="/images/dub-partners/bounty-submission.png"
...
| [Submission frequency](#submission-frequency) (optional) | Set the time between submissions partners can make. [Learn more](/help/article/program-bounties#submission-frequency)                                                                                                                                                     |
...
<Frame>
  <img
    src="/images/dub-partners/submission-window.png"
    alt="Submission window"
  />
</Frame>
...
<Frame>
  <img
    src="/images/dub-partners/submission-frequency.png"
    alt="Submission frequency"
  />
</Frame>
...
<Frame>
  <img
    src="/images/dub-partners/bounty-submission-criteria.png"
    alt="Submission requirements"
  />
</Frame>

By default, partners claiming a submission bounty are asked to describe how they completed the bounty using a text field.

<Frame>
  <img
    src="/images/dub-partners/submission-default.png"
...
<Frame>
  <img
    src="/images/dub-partners/bounty-submission-custom-amount.png"
    alt="Create submission bounty"
  />
</Frame>
...
<Tip>
  Social metrics bounties are only available on [Advanced plan and
  above](https://dub.co/pricing/partners).
</Tip>
...
<Frame>
  <img
    src="/images/dub-partners/bounty-social-metrics.png"
    alt="Create submission bounty"
  />
</Frame>
...
<Frame>
  <img
    src="/images/dub-partners/bounty-social-metric-criteria.png"
    alt="Setting social metric submissions criteria"
  />
</Frame>
...
<Frame>
  <img
    src="/images/dub-partners/bounty-social-metric-criteria-variable.png"
    alt="Social metric — variable bonus configuration"
  />
</Frame>

In this example, the program is rewarding an additional \$10 per 100 likes on the submitted post, up to 1,000 likes.

## Bounty Duration

For all bounty types, you can set a start and end date for the bounty. By default, all bounties start on the creation date, and have no end date.

<Frame>
  <img src="/images/dub-partners/bounty-duration.png" alt="Bounty duration" />
</Frame>

### Bounty start date

For the bounty start date, you can select from the following options:

| Start date               |                                                                                                                                                     |
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| Today                    | The default selection. Starts when the bounty is created.                                                                                           |
| In 2 weeks               | Starts 2 weeks after the bounty is created.                                                                                                         |
| In 1 month               | Starts 1 month after the bounty is created.                                                                                                         |
| In 6 months              | Starts 6 months after the bounty is created.                                                                                                        |
| When a new partner joins | Starts when a new partner joins your program. The bounty will not be visible to existing partners that have joined before the bounty creation date. |
| Custom                   | Select a specific date for the bounty to start using a date picker.                                                                                 |

<Frame>
  <img
    src="/images/dub-partners/bounty-startdate.png"
    alt="Bounty start date"
  />
</Frame>

### Bounty end date

For the bounty end date, you can select from the following options:

| End date |                                                                   |
| -------- | ----------------------------------------------------------------- |
| Never    | The default selection. The bounty eligibility never ends.         |
| 2 weeks  | Ends 2 weeks after the bounty start date.                         |
| 1 month  | Ends 1 month after the bounty start date.                         |
| 6 months | Ends 6 months after the bounty start date.                        |
| Custom   | Select a specific date for the bounty to end using a date picker. |

<Frame>
  <img src="/images/dub-partners/bounty-enddate.png" alt="Bounty end date" />
</Frame>
...
<Note>
  ...
  submission is approved via the dashboard or the
  [API](/docs/api-reference/endpoint/approve-a-bounty-submission).
</Note>
...
If you rejected a submission by mistake, or a partner asks to revise a submission you've already reviewed, you can reopen it from the submission review view. Reopening returns the submission to a **draft** state so the partner can edit and resubmit it.

When you reopen a submission:

- Its status is reset to `draft`.
- Any rejection reason and note you previously set are cleared.
- The completion and review timestamps are cleared, so the submission behaves as if it had not yet been submitted.
- No commission is created until the partner resubmits and you approve it.

<Note>
  Approved submissions can't be reopened, since a commission has already been
  created for them. If you need to reverse an approved submission, [contact
  support](https://dub.co/help).
</Note>
