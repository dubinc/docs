...
| Start date (optional)  | Bounty start date. Partners will receive an email notification on this date about the bounty. If one is not selected, the bounty will start on the creation date. [Learn more](/help/article/program-bounties#start-date)                     |
| End date (optional)    | Bounty end date. If set, bounty will "expire" after the end date and will no longer be eligible for commission. [Learn more](/help/article/program-bounties#end-date)                                                                       |
