...
You can also [list](/docs/api-reference/discount-codes/list), [create](/docs/api-reference/discount-codes/create), and [delete](/docs/api-reference/discount-codes/delete) discount codes via the API. If you're using a **custom** discount provider, listen to [`discount_code.created`](/docs/webhooks/events/discount-code-created) and [`discount_code.deleted`](/docs/webhooks/events/discount-code-deleted) to sync codes with your own billing system.
