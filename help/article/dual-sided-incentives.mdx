...
You can also [list](/docs/api-reference/discount-codes/list), [create](/docs/api-reference/discount-codes/create), and [delete](/docs/api-reference/discount-codes/delete) discount codes via the API.
...
You can optionally [auto-provision discount codes](#auto-provision-discount-codes) so codes are created for existing and future partners in this group.
...
You can also [list](/docs/api-reference/discount-codes/list), [create](/docs/api-reference/discount-codes/create), and [delete](/docs/api-reference/discount-codes/delete) codes via the API. Each referral link can only have one discount code.
