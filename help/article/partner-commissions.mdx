...
You can change a commission [statuses](/help/article/partner-commissions#commission-status) for all unpaid commissions, and edit the [earnings amount](/help/article/partner-commissions#earnings-amount) for custom commissions.
...
With the edit commission model open, you can change the status of any commission that hasn't been paid yet.
...
If you change a commission's status to `Cancelled` of `Fraud`, you're also able to mark all previous commissions for this customer-partner pair as that status too. This will also prevent the partner from earning future commissions from this customer.
...
### Earnings amount
You can only edit the earnings amount for `custom rewards` that haven't been paid yet. If the earnings amount is changed, it will also appear in the activity log on the [commissions page](/help/article/partner-commissions#single-commission-view).
