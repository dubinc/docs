...
You can change a commission's [status](/help/article/partner-commissions#commission-status) for all unpaid commissions, and edit the [earnings amount](/help/article/partner-commissions#earnings-amount) for custom commissions.

### Commission status
To change the commission's status, this can be completed from one of two areas:
...
With the edit commission modal open, you can change the status of any commission that hasn't been paid yet.
...
<Frame>
  <img
    src="/images/dub-partners/edit-commission-custom.png"
