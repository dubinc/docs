...
Then, from your [short links page](https://app.dub.co/links), click on the `⋮` button under the **Create Link** button and select **Import from Short.io**.
...
<Frame>
  <img
    src="/images/dub-links/import-from-short-modal.png"
...
<Frame>
  <img
    src="/images/dub-links/imported-short-domains.png"
