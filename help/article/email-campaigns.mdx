...
- **Groups**: Choose specific partner groups or send to All Groups
- **Tags**: Choose specific partner tags, or send to all tags
...
Click **Add condition** to add additional logic conditions. You're able to add one of each logic conditions, targeting the exact partners you need for the campaign.

<Tip>
**Joins the program** logic cannot be combined with other conditions, as the partner will never have additional stats at that time.
</Tip>
...
<Frame>
  <img src="/images/dub-partners/email-partnervariables.png" alt="Partner email variables" />
</Frame>
...
<Tip>
  If you're using a custom description for your rewards, the custom description will show instead of the simplified version.
</Tip>
...
<Frame>
  <img src="/images/dub-partners/email-image-alt-text.png" alt="Email alt text" />
</Frame>
