...
| Partner variables | `@PartnerName`, `@PartnerEmail`, `@PartnerLink`, `@SaleReward`, `@LeadReward`, `@ClickReward`, `@ReferralReward`, [Learn more](/help/articles/email-campaigns/#partner-variables)           |
