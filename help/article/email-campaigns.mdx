...
You can also add enrich your emails with images by clicking the **Insert image** button in the content editor. 
...
To add alternative text to images, hover over the added image and clicking the **Alt** button in the bottom-right corner. Then you can add a short description of the image for accessibility and SEO purposes.
