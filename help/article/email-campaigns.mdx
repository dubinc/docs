...
- **From**: The sender's name and email address. You can customize the username (the part before the `@`). Replies are sent to your program's [support email address](/help/article/program-resources#support-email).
- **Groups**: Choose specific [partner groups](/help/article/partner-groups) or send to `All Groups`
- **Tags**: Choose specific [partner tags](/help/article/partner-tags), or send to `All Tags`
...
<Frame>
  <img
    src="/images/dub-partners/email-content-marketing.png"
...
<Frame>
  <img
    src="/images/dub-partners/email-content-transactional.png"
...
<Frame>
  <img
    src="/images/dub-partners/email-content-logic.png"
    alt="Transactional logic"
  />
</Frame>

Click **Add condition** to add additional logic conditions. You're able to add one condition of each logic type, targeting the exact partners you need for the campaign.

<Tip>
  **Joins the program** logic cannot be combined with other conditions, as the
  partner will never have additional stats at that time.
</Tip>
...
<Frame>
  <img src="/images/dub-partners/email-text.png" alt="Email text styles" />
</Frame>
...
| Bulleted lists    | `- First item` `- Second item`                                                                                                                                                   |
| Headings          | `# Heading level 1` and `## Heading level 2`                                                                                                                                     |
| Partner variables | `@PartnerName`, `@PartnerEmail`, `@PartnerLink`, `@SaleReward`, `@LeadReward`, `@ClickReward`, `@ReferralReward`, [Learn more](/help/article/email-campaigns/#partner-variables) |

### Partner Variables

Use the `@` button in the email editor to insert personalized partner information and reward details. Dub replaces these variables with the corresponding values when the email is sent.

<Frame>
  <img
    src="/images/dub-partners/email-partnervariables.png"
    alt="Partner email variables"
  />
</Frame>

| Variable         | Output                                                                                                                           | Example                                          |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| `PartnerName`    | The partner’s name                                                                                                               | Alex Johnson                                     |
| `PartnerEmail`   | The partner’s email address                                                                                                      | alex@email.com                                   |
| `PartnerLink`    | The partner’s first enrollment referral link                                                                                     | getacme.link/alex                                |
| `SaleReward`     | A simplified description of the partner’s sale reward                                                                            | 30% per sale for 6 months                        |
| `LeadReward`     | A simplified description of the partner’s lead reward                                                                            | $10 per lead                                     |
| `ClickReward`    | A simplified description of the partner’s click reward                                                                           | $0.50 per click                                  |
| `ReferralReward` | A simplified description of the partner’s referral reward. [Learn more about partner referrals](/help/article/partner-referrals) | 10% per referred partner’s commission for 1 year |

<Tip>
  If you're using a custom description for your rewards, the custom description
  will show instead of the simplified version.
</Tip>

### Images

You can also enrich your emails with images by clicking the **Insert image** button in the content editor.

<Frame>
  <img src="/images/dub-partners/email-image.png" alt="Email image button" />
</Frame>

Clicking will open your system file browser to select an image to use. It will be uploaded in the email where your cursor is located. You can also drag and drop images directly into the content area.
...
<Frame>
  <img
    src="/images/dub-partners/email-image-alt-text.png"
    alt="Email alt text"
  />
</Frame>
