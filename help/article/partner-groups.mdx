...
You can also filter your [program analytics](/help/article/program-analytics#filtering-your-data) and [commission analytics](/help/article/commission-analytics#filtering-commission-analytics) by partner group, or use [partner tags](/help/article/partner-tags) for more flexible labeling.
...
<Tip>
  Group move rules are only available on [Advanced plan and
  above](https://dub.co/pricing).
</Tip>

Group move rules lets you automatically move partners into a selected group when they meet specific criteria. This is useful when you want partners to earn higher rewards as they progress in your program, without needing to manually move them from one group to another.

For instance, you can move partners to the `VIP Group` once their total commissions reach $100:

<Frame>
  <img
    src="/images/dub-partners/move-group-rules.png"
    alt="Example group move settings"
  />
</Frame>

You can also include/exclude certain groups from being subject to the move rule by adding an optional group condition – e.g. partners must be in the `Publisher` group to be automatically moved to the `VIP Group` when their total commissions reach $100:

<Frame>
  <img
    src="/images/dub-partners/move-group-rules-condition.png"
    alt="Group move rule condition"
  />
</Frame>

After adding your performance condition, click **Add condition**, then choose whether the partner group **is**, **is not**, **is one of**, or **is not one of** the selected group or groups. The partner must meet both the performance criteria and this group condition to be moved.

<Note>
  Partners with a custom [partner-level or link-level reward](/help/article/partner-rewards#partner-level-rewards) or [discount](/help/article/dual-sided-incentives#partner-level-discounts) are automatically excluded from group move rules, so they won't be accidentally moved to another group and lose their custom reward or discount.
</Note>
...
**Via the partner details page**

You can move a partner to a new group from their [partner details page](/help/article/managing-program-partners#viewing-partner-details):

<Frame>
  <img
    src="/images/dub-partners/partner-profile-page-group.png"
    alt="Partner profile page group"
  />
</Frame>

Anytime you're changing a partner's group, you can enable **keep partner in selected group** to ignore any group move rules. This setting is also available from the partner's [advanced settings](/help/article/managing-program-partners#advanced-settings).

<Frame>
  <img
    src="/images/dub-partners/move-single-modal.png"
    alt="Partner move modal"
  />
</Frame>
...
<Frame>
  <img
    src="/images/dub-partners/partner-group-change-email.png"
    alt="Group move email"
  />
</Frame>
...
<Frame>
  <img
    src="/images/dub-partners/group-move-logs.png"
...
| Plan                                    | Partner groups                           |
| --------------------------------------- | ---------------------------------------- |
| [Business](https://dub.co/pricing)      | Up to 3 groups (including Default group) |
| [Advanced](https://dub.co/pricing)      | Unlimited groups                         |
