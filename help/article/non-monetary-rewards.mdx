...
1. [Manually move the partner](/help/article/partner-groups#moving-partners-between-groups) to the new group from the [partner details page](/help/article/partner-details) or via the [partner table](http://app.dub.co/program/partners).
