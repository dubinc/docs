...
If this partner has any pending commissions, you'll see the list of all commissions on hold. These are any commissions that have occurred since the flagged event. [Learn more here](/help/article/fraud-detection#associated-commissions).
...
- When [resolving](/help/article/fraud-detection#resolve-fraud-event) the event, any commissions not marked as `Fraud` will move to `Pending`
- When [banning](/help/article/fraud-detection#ban-partner) the partner, this will change any `On hold` commissions to `Canceled`.
...
When banning a partner, you may want to report them to Dub for further investigation or a network ban. To do this, click the toggle **Flag partner for potentiall fraud**, and provide as much detail as you can about the event. 
