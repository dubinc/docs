...
- You can individually change the commmission status to `Fraud` by clicking the `⋯` button and select **Edit commission**.
...
- When [banning](/help/article/fraud-detection#ban-partner) the partner, this will change any `On hold` commmissions to `Cancelled` 
