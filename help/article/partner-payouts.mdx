...
<Note>
  The payout holding period only applies to `click`, `lead`, and `sale` commissions – it does **not** apply to `custom` commissions.

This means that [bounty commissions](/help/article/program-bounties) and [manually created one-time commissions](/help/article/partner-commissions#one-time-commissions) (which are both recorded as `custom` commissions) become eligible for payout immediately at the next payout cycle, regardless of your group's holding period. This applies whether the commission is created via the dashboard or the [API](/docs/api-reference/commissions/create).
...
<Frame>
  <img
    src="/images/dub-partners/payout-multi-select.png"
    alt="Multi-selecting partners for payout"
  />
</Frame>
...
<Frame>
  <img src="/images/dub-partners/exclude-payout.png" alt="Excluding payouts" />
</Frame>
...
| Credit card                                     | [Business / Advanced](https://dub.co/pricing): 8% <br/> [Enterprise](https://dub.co/enterprise): 6% | Instant               |
