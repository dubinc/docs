...
[Auto-approval](#auto-approve) is configurable at the individual group level, and allows you to automatically approve applications that meet the eligibility criteria.

### Marketplace settings
If your program is listed in the [Dub marketplace](https://dub.co/help/article/program-marketplace), click the **Marketplace** toggle to access the marketplace settings. Here you can set the description that's shown to partners, and categories to help find your program more easily.
...
<Step title="Auto-approve" id="auto-approve">
