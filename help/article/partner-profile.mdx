...
<Warning>
  Updating your email or profile type will reset your Stripe account, which
  will require you to restart the [payout connection
  process](/help/article/receiving-payouts).

Once you've received payouts on Dub, you won't be able to update your email or
profile type. [Reach out to support](https://dub.co/contact/support) if you
still need to make any updates.

To change your country, please [reach out to
support](https://dub.co/contact/support) regardless of whether you've received
payouts on Dub – country changes are handled by our team for compliance
reasons.
