...
1. **Pricing that scales with your success**: You can start your affiliate program on Dub with [as little as $90/month](https://dub.co/pricing) and only 5% payout fees. As you grow, payout fees drop to 3%, giving you the flexibility to reward partners without high costs eating into your margins.
2. **Modern UI with enterprise-grade capabilities**: Dub's modern interface makes it simple for both you and your partners to navigate without a learning curve. You can use our [Embedded Referral Dashboard](/docs/partners/embedded-referrals) to create a seamless referral experience, or leverage our best-in-class [Risk Monitoring](/help/article/risk-monitoring) feature to ensure the safety/compliance of your program. The possibilities are endless.
...
<Frame>
  <img
    src="/images/dub-partners/import-partnerstack-modal.png"
...
- In an "approved" state ([docs](https://docs.partnerstack.com/reference/get_v2-partnerships-2#query-params-approved_status))
