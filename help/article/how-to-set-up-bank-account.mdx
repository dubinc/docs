...
With the bank account verification modal open, enter the six-digit code in the statement descriptor of the deposit you received from Dub, then click `Verify`.
