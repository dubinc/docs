...
| ------------------- | ------------------------------------------ | ------------------------------------------ |
| Fees                | 0.5% transaction fee                       | No transaction fee                         |
...
<Note>Stablecoin payouts are subject to a 0.5% transaction fee.</Note>
...
<Frame>
  <img
    src="/images/dub-partners/default-payout-method.png"
    alt="Selecting your default payout method"
  />
</Frame>
...
Once you have an LLC ready, go to your [partner profile settings](https://partners.dub.co/settings) and update:

- **Profile Type** – Set to "Company"
- **Legal company name** – Enter your LLC's legal name

Your profile country is based on your current location and cannot be changed in the dashboard. After setting up your legal entity, [contact support](https://dub.co/contact/support) so we can update your country to match (e.g. United States).
