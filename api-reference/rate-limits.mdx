...
Dub's [Analytics endpoints](/concepts/analytics/introduction) have separate, more restrictive rate limits to ensure optimal performance:
...
- [`GET /events`](/api-reference/endpoint/retrieve-a-list-of-events) – retrieving a list of events
