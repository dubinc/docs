...
[Analytics endpoints](/concepts/analytics/introduction) have separate, more restrictive rate limits to ensure optimal performance:
...
| [Enterprise](https://dub.co/enterprise) | 20 requests per second   |

Analytics endpoints include:
- `/analytics/*` - All analytics retrieval endpoints
- `/events/*` - All event tracking endpoints
