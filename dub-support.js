(function () {
  ...
  function init() {
    ...
    iframe.style.cssText =
      "display:none;position:fixed;bottom:0;right:0;z-index:2147483646;" +
      "width:580px;height:100%;max-width:100vw;border:none;" +
      "background:transparent;color-scheme:auto;";
    ...
    button.addEventListener("click", function () {
      ...
      setTimeout(function () {
        iframe.contentWindow &&
          iframe.contentWindow.postMessage({ type: "dub-support-open" }, "*");
      }, 50);
    });
