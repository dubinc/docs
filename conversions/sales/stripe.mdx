...
<Step title="Find Dub on the Stripe App Marketplace">
 Navigate to the [Dub: Conversions Analytics page](https://d.to/stripe) on the Stripe App Marketplace.
...
For simplicity, Dub records all sales in the native currency of the Stripe account.
