...
<Step title="Install the app">
  Install the Dub Conversions app from the Shopify App Store.

  <Tip>
    Our Shopify integration is still in closed beta and would require a [Business plan](https://dub.co/help/article/business-plan) subscription and above. If you'd like to join the beta, [reach out to us via email](mailto:support@dub.co?subject=I%20want%20to%20use%20the%20Dub%20Shopify%20integration%20for%20conversion%20tracking).
  </Tip>
</Step>
