...
<Warning>
  Lead commissions will not be created when using direct sale tracking. If you need to reward partners for lead events, use [standard sale tracking](/conversions/sales/introduction) instead. [Learn more about configuring reward types](https://dub.co/help/article/partner-rewards#configuring-reward-types).
</Warning>
