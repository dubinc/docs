...
The first event you'll want to send is a `lead` event. This happens when a user performs an action that indicates interest in your product or
...
Once you've enabled conversion tracking for your links, all your tracked conversions will show up on your [Analytics dashboard](/help/article/dub-analytics). We provide 3 different views to help you understand your conversions:
