...
During the installation, Dub will automatically create 3 properties to your contact object:

- **Dub Id** - Unique identifier for tracking the specific Dub link that generated the lead
- **Dub Link** - The actual Dub link URL that the lead clicked to reach your site
- **Dub Partner Email** - Email address of the partner who created the Dub link (if applicable)
...
<Tip>
If you can't see these properties in your HubSpot contact object after installation, something went wrong with the integration setup. Please [contact us](mailto:support@dub.co) for assistance.
</Tip>
