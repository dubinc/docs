...
For security reasons, the domain should be a [subdomain](https://dub.co/help/article/how-to-add-custom-domain#step-2b-adding-a-subdomain) of your website domain. This will prevent unauthorized domains from sending click-tracking requests to your Dub workspace.

E.g. if your website domain is `example.com`, your short domain should be something like `go.example.com`.
...
export default function App() {
  return (
    <Layout>
      <DubAnalytics domain="go.example.com" />
      {/* Your app code here */}
    </Layout>
  );
}
...
export default function App() {
  return (
    <Layout>
      <DubAnalytics apiHost="/_proxy/dub" domain="go.example.com" />
      {/* Your app code here */}
    </Layout>
  );
}
