...
<Tip>
  For security reasons, the domain should be a
  [subdomain](https://dub.co/help/article/how-to-add-custom-domain#step-2b-adding-a-subdomain)
  of your website domain. This will prevent unauthorized domains from sending
  click-tracking requests to your Dub workspace.
</Tip>
