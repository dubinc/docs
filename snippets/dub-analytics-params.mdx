...
<ParamField body="data-domains" type="JSON-stringified object">
  ...
  <Expandable title="properties">
    <ParamField body="refer" type="string">
      The Dub short domain for referral program client-side click tracking (previously `data-short-domain`).
...
<ParamField body="data-short-domain" type="string" deprecated>
  [Deprecated: Use `data-domains.refer` instead. The custom domain you're using
  on Dub for your short links.
</ParamField>
