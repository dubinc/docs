...
<ParamField body="domain" type="string">
  The domain to use for client-side click tracking. This should be a subdomain
  of your website domain. E.g. if your website domain is `example.com`, your
  short domain should be something like `go.example.com`.
</ParamField>
