...
<ResponseField name="trackConversion" type="boolean" default="false" required>
...
<ResponseField name="identifier" type="string | null" required>
...
<ResponseField name="video" type="string | null" required>
...
<ResponseField name="programId" type="string | null" required>
