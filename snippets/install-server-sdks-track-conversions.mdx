...
<Tip>
  If you are using Stripe or Shopify, you can skip this step since our native
  integrations will automatically track conversions for you. Read the
  [Stripe](/conversions/sales/stripe) or [Shopify](/conversions/sales/shopify)
