...
<Tip>
  The `customerExternalId` should be a unique identifier for the customer in
  your system. While the examples above use an email address, it can be any
  value that uniquely identifies the user (e.g., user ID).
</Tip>
